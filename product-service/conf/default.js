...
module.exports = {
	...
	session: {
		...
		encryptionKey: 'zmtY32q0FWmIMTAAjNg6KeLHJWiefW/frPjXVbHSHCc=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'vidD/Mt+4Z7NesK9TBdcc+Qvlk8VNjGNj4NHMFutmtfBBY2EGduSQySg5gPccRenvxKulNslCuMN+D70VPYzuQ==',
		secret: 'ssTNx0K7i2Im4+3oDkb/ufrUG9YnPAtg', // should be a large unguessable string
	...
	cookieSecret: '3bQ2jhHbH2H+n5jFqJJvwohihcyGvX+O',
